defmodule DonationWeb.UserControllerTest do
  use DonationWeb.ConnCase

  alias Donation.Admins

  @create_attrs %{encrypted_password: "some encrypted_password", is_admin: true, name: "some name", username: "some username"}
  ...
  def fixture(:user) do
    {:ok, user} = Admins.create_user(@create_attrs)
    user
  end
